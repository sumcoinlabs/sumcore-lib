...
* [Peer to Peer Networking](https://github.com/sumcoinlabs/sumcore-p2p)
...
var imported = sumcore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new sumcore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new sumcore.URI(paymentInfo).toString();
```
