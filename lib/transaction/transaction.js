...
Transaction.MAX_MONEY = 100000000 * 1e8; // Sumcoin has 100M coins
...
Transaction.FEE_PER_KB = 100000; // Sumcoin default fees is 0.001 LTC
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://sumcore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by sumcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a sumcore Address object. The
 * same is true for `script`, which can be a string or a sumcore Script.
 *
